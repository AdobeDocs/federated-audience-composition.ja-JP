...
Federated Audience Compositionの宛先への接続を設定している場合は、「エンリッチメント」アクティビティを使用して、Adobe Experience Platformに送信されるデータを外部データベースの属性でエンリッチメントできます。[外部データを使用してAdobe Experience Platform オーディエンスを強化する方法について説明します](../connections/destinations.md)
