...
データモデルは、スキーマ、オーディエンスおよびこれらの間のリンクのセットです。モデルを使用すると、データベースのデータをオーディエンスに組み合わせることができます。
...
2. 指定されたフォームに入力して、リンクを定義します。
   ...
   * **一対一**：ソーステーブルの 1 つのオカレンスは、最大でターゲットテーブルの 1 つのオカレンスに対応させることができます。
   ...
   ![モデルに対して複数の結合リンクを作成できるプラスボタンがハイライト表示されています](assets/models/multi-join.png){zoomable="yes"}
...
2. ソース結合の横にある ![](assets/models/do-not-localize/Smock_AddCircle_18_N.svg) ボタンをクリックし、矢印をターゲット結合までドラッグして、接続を確立します。
