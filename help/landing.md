...
[![画像](assets/learn-more-button.svg)](release-notes/latest.md)

>[!TAB データの接続]

外部データベースへの接続を作成、設定、テストおよび保存します。

[![画像](assets/learn-more-button.svg)](connections/home.md)

>[!TAB オーディエンスの構成]

アクティビティの追加と設定（分割、エンリッチメント、クエリなど） オーディエンスを作成するのに最適な方法です。

[![画像](assets/learn-more-button.svg)](compositions/home.md)
