...
1. 「**[!UICONTROL 属性]**」フィールドで、条件の作成に活用するデータベースから属性を選択します。属性リストには、リンクされたテーブルの属性を含む、データベースのすべての属性が含まれます。

   ![](assets/query-custom-condition-fields.png){zoomable="yes"}

   >[!NOTE]
   >
   >「**[!UICONTROL 式を編集]**」ボタンを使用すると、式エディターを活用し、データベースのフィールドとヘルパー関数を使用して式を手動で定義できます。[式の編集方法を学ぶ](expression-editor.md)
...
1. 「**[!UICONTROL 値]**」フィールドで、期待値を定義します。また、式エディターを利用して、データベースのフィールドとヘルパー関数を使用して式を手動で定義することもできます。それには、「**[!UICONTROL 式を編集]**」ボタンをクリックします。[詳しくは、式の編集方法を参照してください](expression-editor.md)
...
1. コンポーネントをペーストするには、目的のトランジションの最後にある「+」ボタンをクリックし、「**[!UICONTROL n 個の項目をペースト]**」を選択します。
...
フィルタリング条件を相互にリンクするために使用する演算子を変更するには、この演算子をクリックし、右側に開く&#x200B;**[!UICONTROL グループ]**&#x200B;パネルで目的の演算子を選択します。
